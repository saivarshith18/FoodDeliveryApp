...
<div class="cart">
            ...
            %>
                ...
                <div class="profile">
                    ...
                    <div class="profile-popup" id="profile-popup">
                        ...
                        <a href="OpenPage.jsp" class="btn btn-danger btn-sm">Logout</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Main Content -->
    <div class="container">
        <h5 class="text-center mb-4" style="color:#66BB6A;">Menu Items</h5>

        <!-- Row to display menu items -->
        <div class="row">
            <% 
                ArrayList<Menu> menuItems = (ArrayList<Menu>) session.getAttribute("menuItems");
            ...
            %>
            <div class="col-12 text-center">
                <p class="text-danger">No menu items available,Choose any <a href="Restaurant.jsp">Restaurant</a>.</p>
            </div>
            <% } %>
        </div>
    </div>
