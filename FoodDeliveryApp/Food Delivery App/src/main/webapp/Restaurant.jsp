...
<div class="cart">
    ...
    <!-- Main Content -->
    <div class="container">
        <h5 class="text-center mb-4" style="color:#66BB6A;">Restaurants with online food delivery</h5>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="<%= restaurant.getImagePath() %>" class="card-img-top" alt="<%= restaurant.getName() %>">
                    <div class="card-body">
                        ...
                        <a href="Menu?RestaurantId=<%= restaurant.getRestaurantId() %>" class="btn btn-primary btn-sm mt-2">View Menu</a>
                    </div>
                </div>
            </div>
            <% 
            ...
            %>
            <div class="col-12">
                <p class="text-center text-danger">No restaurants available at the moment.</p>
            </div>
            <% } %>
        </div>
    </div>
